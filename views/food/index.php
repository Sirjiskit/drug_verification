            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="w-100" style="width: 100%;">
                        ...
                        <table class="table table-striped table-bordered table-hover dt-responsive nowrap" id="tb-food">
                            <thead>
                            ...
                            <tbody>
                                ...
                                foreach ($this->food as $row):
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo htmlentities($row["ingredient"]); ?></td>
                                        <th>
                                            ...
                                            <?php if (((int) $row["days"] == 0 || (int) $row["days"] <= 25) && strtotime($row["doe"]) >= time()): ?>
                                                <span class="text-warning"><?php echo htmlentities($row["days"]) ?> Exp. in day(s)</span>
                                            <?php endif; ?>
